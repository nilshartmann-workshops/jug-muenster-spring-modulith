...
- [`schritte`](https://github.com/nilshartmann-workshops/jug-muenster-spring-modulith/tree/schritte): this contains all code that I intended to show. In the [commit list of that branch](https://github.com/nilshartmann-workshops/jug-muenster-spring-modulith/commits/schritte/) you find single commits each with one (sub)topic we discussed. **Probably the best way to "get started" with this application and the talk,** just look at the Git diff for each commit.
- [`live_coding`](https://github.com/nilshartmann-workshops/jug-muenster-spring-modulith/tree/live_coding): that is the code that I wrote during the talk
